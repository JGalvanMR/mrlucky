...
Route::get('/boletin/{slug}', [SiteController::class, 'boletin'])->name('es.boletin');
Route::get('/en/newsletter/{slug}', [SiteController::class, 'boletin'])->name('en.boletin');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'ranchos'], function () {
        Route::get('/', [RanchoController::class, 'index'])->name('ranchos');
        Route::get('agregar', [RanchoController::class, 'agregarForm'])->name('ranchos.agregar_form');
        Route::post('agregar', [RanchoController::class, 'agregar'])->name('ranchos.agregar');
        Route::get('editar/{hash_id}', [RanchoController::class, 'editarForm'])->name('ranchos.editar');
        Route::post('editar/{hash_id}', [RanchoController::class, 'editar'])->name('ranchos.editar_post');
        Route::post('eliminar/{hash_id}', [RanchoController::class, 'eliminar'])->name('ranchos.eliminar');
        Route::post('subir-imagen', [RanchoController::class, 'subirImagen'])->name('ranchos.subir_imagen');
        Route::post('eliminar-imagen', [RanchoController::class, 'eliminarImagen'])->name('ranchos.eliminar_imagen');
        Route::post('subir-pdf', [RanchoController::class, 'subirPdf'])->name('ranchos.subir_pdf');
        Route::post('eliminar-pdf', [RanchoController::class, 'eliminarPdf'])->name('ranchos.eliminar_pdf');
    });
    ...
    Route::group(['prefix' => 'components'], function () {
        Route::get('date', fn () => view('admin.modules.components.date'))->name('components_date');
        Route::get('summernote', fn () => view('admin.modules.components.summernote'))->name('components_summernote');
        Route::get('bootstrap-toggle', fn () => view('admin.modules.components.bootstrap-toggle'))->name('components_toggle');
        Route::get('data-tables', fn () => view('admin.modules.components.data-tables'))->name('components_datatables');
        Route::get('btn-eliminar', fn () => view('admin.modules.components.btn-eliminar'))->name('components_eliminar');
        Route::get('select2', fn () => view('admin.modules.components.select2'))->name('components_select2');
        Route::get('money', fn () => view('admin.modules.components.money'))->name('components_money');
        Route::get('color-picker', fn () => view('admin.modules.components.color-picker'))->name('components_colorpicker');
        Route::get('tags-input', fn () => view('admin.modules.components.tags-input'))->name('components_tagsinput');
        Route::get('file-input', fn () => view('admin.modules.components.file-input'))->name('components_fileinput');
        Route::get('slugify', fn () => view('admin.modules.components.slugify'))->name('components_slugify');
        Route::get('maxlength', fn () => view('admin.modules.components.maxlength'))->name('components_maxlength');
        Route::get('fontpicker', fn () => view('admin.modules.components.fontpicker'))->name('components_fontpicker');
        Route::get('iconpicker', fn () => view('admin.modules.components.iconpicker'))->name('components_iconpicker');
    });
});
