        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editarForm" action="{{ route('usuarios.editar', ['hash_id'=>Hashids::encode($usuario->id)]) }}" class="form-horizontal form-bordered m-t-40">
                            <div class="form-body">
                                <div class="form-group row">
                                    <label class="control-label text-md-right col-md-3">*Nombre</label>
                                    <div class="col-md-7">
                                        <input type="text" name="name" class="form-control" value="{{ $usuario->name }}" data-error="*El nombre es requerido." required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="email" name="email" class="form-control" value="{{ $usuario->email }}" data-error="*Ingrese un correo válido." data-required-error="*El correo es requerido." required>
                                        <small class="help-block with-errors text-danger"></small>
                                    </div>
                                </div>
                                <div class="form-group row">
...
@section('customJS')
    ...
    <x-validator /> 
    <x-ajax-form id="editarForm" titulo="Editar usuario" reload="1" />
@stop
