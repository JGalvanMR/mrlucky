...
@section('titulo', 'Agregar vacantes')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Agregar Vacante</h4>
                    </div>
                    <div class="card-body">
                        <form id="agregarForm" action="{{ route('vacantes.agregar') }}" class="form-horizontal form-bordered m-t-40">
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <x-file-input name="imagen" route="{{ route('uploads_subir') }}" folder="vacantes/imagenes" filecount="1" scripts="1" />
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
...
@section('customJS')
    ...
    <x-ajax-form id="agregarForm" titulo="Agregar Vacante" reload="1" />
@stop