            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Editar Proveedor</h4>
                    </div>
                    <div class="card-body">
                        <form id="editarForm" action="{{ route('proveedores.editar', ['hash_id'=>Hashids::encode($proveedor->id)]) }}" class="form-horizontal form-bordered m-t-40">
                            ...
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select name="tipo" class="form-control select2" data-error="*El tipo de proveedor es requerido." required>
                                            ...
                                            <option value="tal" {{ ($proveedor->tipo == 'tal') ? 'selected' : '' }}>Taller</option>
                                            <option value="ref" {{ ($proveedor->tipo == 'ref') ? 'selected' : '' }}>Refaccionaria</option>
                                            <option value="gru" {{ ($proveedor->tipo == 'gru') ? 'selected' : '' }}>Grúa</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="rfc" class="form-control" value="{{ $proveedor->rfc }}" data-error="*El RFC es requerido." required>
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="razon_social" class="form-control" value="{{ $proveedor->razon_social }}" data-error="*La razón social es requerida." required>
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="alias" class="form-control" value="{{ $proveedor->alias }}">
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select id="estados" name="estado_id" class="form-control select2">
                                            ...
                                            @foreach($estados as $estado)
                                                <option value="{{ $estado->id }}" {{ ($estado->id == @$proveedor->ciudad->estado_id) ? 'selected' : '' }}>{{ $estado->estado }}</option>
                                            @endforeach
                                        </select>
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <x-bootstrap-toggle name="activo" onText="Activo" offText="Inactivo" checked="{{ $proveedor->activo }}" />
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
...
@section('customJS')
                ...
                $.ajax({
                    ...
                    success: function(ciudades){
                        ...
                        $.each(ciudades, function(key, ciudad){
                            if(ciudad.id == {{ (int)$proveedor->ciudad_id }} ){
    ...
    <x-ajax-form id="editarForm" titulo="Editar Proveedor" reload="1" />
@stop