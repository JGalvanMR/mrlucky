            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Agregar Zona</h4>
                    </div>
                    <div class="card-body">
                        <form id="agregarForm" action="{{ route('zonas.agregar') }}" class="form-horizontal form-bordered m-t-40">
                            {{-- <input type="hidden" name="orden" value="99"> --}}
                            <div class="form-body">
                                <div class="form-group row">
                                    <label class="control-label text-md-right col-md-3">*Zona</label>
                                    <div class="col-md-7">
                                        <input type="text" name="zona" class="form-control" data-error="*La zona es requerida." required>
...
@section('customJS')
    ...
    <x-ajax-form id="agregarForm" titulo="Agregar Zona" reload="1" />
@stop