...
@section('titulo', 'Listado de zonas')
...
@section('page')
    <div class="container-fluid">
        ...
        <div class="m-t-10 m-b-10 text-right">
            <a href="{{ route('zonas.agregar_form') }}" class="btn btn-success btn-xs">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Listado de zonas</h4>
                    </div>
                    <div class="card-body">
