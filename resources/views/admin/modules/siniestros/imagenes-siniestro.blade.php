    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card-info">
                <h4 class="m-b-0 text-white">Imágenes siniestro (Asegurado)</h4>
            </div>
            <div class="card-body">
                <div class="row">

                    @forelse($siniestro->imagenes_siniestro as $imagen)
                        <div class="col-12 col-md-4 my-4">
                            ...
                            <div class="actions pt-1 text-right">
                                <x-btn-eliminar titulo="Eliminar imagen" url="{{ route('siniestros.eliminar_imagen', ['hash_id'=>Hashids::encode($imagen->id)]) }}" scripts="{{ $loop->first }}" btn="1" />
                            </div>
                        </div>  
                    @empty
                        <div class="col-12">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAgregarImagenes" action="{{ route('siniestros.agregar_imagen') }}" data-focus="false" data-disable="false">
                        <input type="hidden" name="siniestro_id" value="{{ $siniestro->id }}">
                        <div class="form-group mb-2">
                            <label for="">Imágenes</label>
                            <x-file-input name="imagen" route="{{ route('uploads_subir') }}" folder="siniestros/{{ $siniestro->id }}" filecount="50" scripts="0" />
                        </div>
                        <div class="form-group mb-2">
