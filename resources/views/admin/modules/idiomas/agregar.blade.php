            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Agregar Idioma</h4>
                    </div>
                    <div class="card-body">
                        <form id="agregarForm" action="{{ route('idiomas.agregar') }}" class="form-horizontal form-bordered m-t-40">
...
@section('customJS')
    @parent
    <x-validator />
    <x-ajax-form id="agregarForm" titulo="Agregar Idioma" reload="1" />
@stop