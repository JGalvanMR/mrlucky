...
@section('titulo', 'Editar categoría receta')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editarForm" action="{{ route('categorias_recetas.editar', ['hash_id'=>Hashids::encode($categoria->id)]) }}" class="form-horizontal form-bordered m-t-40">
                            <div class="form-body">
