...
@section('titulo', 'Listado de asistencias')
...
@section('page')
    <div class="container-fluid">
        ...
        <div class="m-t-10 m-b-10 text-right">
            <a href="{{ route('asistencias.agregar_form') }}" class="btn btn-success btn-xs">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-info">
                        <h4 class="m-b-0 text-white">Listado de asistencias</h4>
                    </div>
                    <div class="card-body">

                        <livewire:asistencia-table />
