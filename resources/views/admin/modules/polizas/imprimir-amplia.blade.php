...
<body style="margin: 0; padding: 0;">
    <div class="caratula" style="position: relative;">
        <img src="{{ asset('caratulas/cobertura-amplia.jpg') }}" style="width: 1100px;">
        ...
        {{-- Marca --}}
        <span style="position: absolute; top: 407px; left: 62px; font-size: 18px">{{ $poliza->submarca->marca->nombre ?? '--' }} </span>

        {{-- Submarca --}}
        <span style="position: absolute; top: 407px; left: 267px; font-size: 18px">{{ $poliza->submarca->nombre ?? '--' }} </span>

        {{-- Modelo --}}
        <span style="position: absolute; top: 407px; left: 472px; font-size: 18px">{{ $poliza->modelo ?? '--' }} </span>

        {{-- Núm. de serie --}}
        <span style="position: absolute; top: 407px; left: 643px; font-size: 18px">{{ $poliza->sum_serie ?? '--' }} </span>

        {{-- Color --}}
        <span style="position: absolute; top: 460px; left: 62px; font-size: 18px">{{ $poliza->color ?? '--' }} </span>

        {{-- Placas --}}
        <span style="position: absolute; top: 460px; left: 306px; font-size: 18px">{{ $poliza->placas ?? '--' }} </span>

        {{-- Motor --}}
        <span style="position: absolute; top: 460px; left: 552px; font-size: 18px">{{ $poliza->num_motor ?? '--' }} </span>

        {{-- Capacidad --}}
        <span style="position: absolute; top: 460px; left: 832px; font-size: 18px">{{ $poliza->capacidad ?? '--' }} </span>

        {{-- Tipo de póliza --}}
        <span style="position: absolute; top: 578px; left: 62px; font-size: 18px">
            @switch($poliza->tipo)
                @case('anu')
                    Anual
                    @break
        ...
        {{-- Fecha de alta --}}
        <span style="position: absolute; top: 578px; left: 350px; font-size: 18px">
        ...
        <span style="position: absolute; top: 578px; left: 700px; font-size: 18px">
