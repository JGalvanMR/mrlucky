...
<body style="margin: 0; padding: 0;">
    <div class="caratula" style="position: relative;">
        <img src="{{ asset('caratulas/tipo-c.jpg') }}" style="width: 1100px;">
        ...
        {{-- Tipo de póliza --}}
        <span style="position: absolute; top: 590px; left: 62px; font-size: 18px">
            @switch($poliza->tipo)
                @case('anu')
                    Anual
                    @break
        ...
        {{-- Fecha de alta --}}
        <span style="position: absolute; top: 590px; left: 350px; font-size: 18px">
        ...
        <span style="position: absolute; top: 590px; left: 700px; font-size: 18px">
