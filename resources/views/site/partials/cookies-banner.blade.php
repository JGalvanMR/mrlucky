...
(function () {
    ...
    btnAccept.addEventListener('click', function () { setConsent('accepted'); });
    btnReject.addEventListener('click', function () { setConsent('rejected'); });
    btnClose.addEventListener('click',  function () { hideBanner(); });
