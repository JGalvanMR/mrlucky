...
<style>
    ...
    #qualityControl .item:hover {
        transform: scale(1.2);
        transition: all .3s;
    }

    #qualityControlSlider .carousel-indicators {
        bottom: -50px;
    }

    #qualityControlSlider .carousel-indicators li {
    ...
    .btn-primusgfs-trigger:hover .primusgfs-chevron {
        color: #fff;
    }
