    ...
    <style>
        * {
        ...
        :root {
            ...
            --green-light: #81c784;
            --blue: #003ca6;
            /* ← color original de viewer.blade.php */
            --blue-mid: #1976d2;
            --gold: #ebb650;
            /* ← color original de viewer.blade.php */
            --bg-deep: #0c0805;
        ...
        /* Responsive móvil (agregado para mantener coherencia) */
...
<body>
        ...
        <div class="controls">
            <button class="ctrl-btn" id="c-first" onclick="goToPage(0)" title="Primera página">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round">
                    ...
                    <polyline points="12 2 5 7 12 12" />
                </svg>
            </button>
    ...
    <script>
        const PDF_URL = "Boletin-14-Grupo-U.pdf"; // Ajusta la ruta si es necesario
        const SCALE = 2.2;
        const JPEG_Q = 0.92;
        ...
        async function loadPDF() {
            try {
                ...
                for (let i = 1; i <= numPages; i++) {
                    ...
                    const rawVP = rawPage.getViewport({
                        scale: 1
                    });
